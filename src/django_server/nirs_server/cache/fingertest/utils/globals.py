...
class UbiNIRSAppMetadata:
    ...
    app_root = "/".join(app_root.split("/")[:-1])
    app_name = app_root.split("/")[-1]
    ...
    if os.path.exists(trained_model_path):
        ...
        with open(untrained_model_path, "rb") as f:
            ...
            model_dict["classes"] = AppSpectrumLabel.objects.filter(app=app_query).values_list("label")
        ...
        print("New model trained for app {}, accuracy = {}.".format(app_name, new_accuracy))
