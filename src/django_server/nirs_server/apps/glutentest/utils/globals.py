...
from .nirs_estimators.predicts import NIRSEstimator, ModelType
...
class UbiNIRSAppMetadata:
    ...
    if os.path.exists(trained_model_path):
        ...
        nirs_estimator = NIRSEstimator(trained_model_path, untrained_model_path, ModelType.classification)
    else:
        # Train new model.
        ...
        while not os.path.exists(trained_model_path):
            time.sleep(0.1)
